...
cbn k = let v0(f, k0) = let v1(x, k1) = let k2(v2) = let v3(k3) = x(k3) in v2(v3, k1) in f(k2) in k0(v1) in k(v0)

cbv k = let v0(f, k0) = let v1(x, k1) = let k2(v2) = let k3(v3) = v2(v3, k1) in k3(x) in k2(f) in k0(v1) in k(v0)
